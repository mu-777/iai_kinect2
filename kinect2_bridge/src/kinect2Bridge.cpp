...
bool Kinect2Bridge::updateStatus() {
    bool any = false;
    for (size_t i = 0; i < COUNT; ++i) {
...
void Kinect2Bridge::processIrDepth(const cv::Mat& ir, const cv::Mat& depth, std::vector<cv::Mat>& images, const std::vector<Status>& status) {
...
void Kinect2Bridge::processColor(const cv::Mat& color, std::vector<cv::Mat>& images, const std::vector<Status>& status) {
    // COLOR
